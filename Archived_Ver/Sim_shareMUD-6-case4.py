...
#expire-submission-refund by consumer
sleep(15)
for i in selection:
    supplierAddr = accountList[i][0]
    TransactFunction("refund",consumerAddr,consumerPK,[curUID,supplierAddr])
    viewBalance()
...
with open("/Users/skoll/v6MarginTest/case4.csv","a") as csvfile:
