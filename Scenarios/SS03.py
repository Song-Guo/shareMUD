...
#Strategy: Highly reputable suppliers are selected
#Code of Ethereum user address: 0~9
consumerCode = int(3) #U4
supplierList = [6,7,8,9] #{U7,U8,U9,U10}
offers = [[2,20],[1,10],[1,8],[3,12],[2,10],[2,15],[3,15],[2,12],[3,10],[2,5]] #[price,data_size] #Number of offers = number of users
selection = [6,7,8] #Assume consumer searched for the reputation of all suppliers and find out that U7,U8,U9 have best reputation among all suppliers who provided an offer
submitList = [6,7,8] #U7,U8,U9
