...
supplierList = [0] #index of list (0~4)
offers = [[14,15],[2,10],[1,8],[3,12],[2,10]] #[price,data_size]
selection = [0] #index of list (0~4), note elements of this list must be included by "supplierList"
submitList = [0] #should be included by selection!
rate = [40] # rate, 0~50 (solidity have limited ability to deal with float number)
